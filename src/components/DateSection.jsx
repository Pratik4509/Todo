...
const DateSection = ({ showAdd }) => {
    ...
    return (
        <div className=' bg-slate-100 text-purple-600 p-6 flex justify-between items-center sticky top-0'>
            ...
            <div>
                {showAdd ?
                    <Link to='/add'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 transition duration-200 ease-in-out hover:animate-spin">
